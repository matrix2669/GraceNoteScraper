...
const node=()=>({value:'',hidden:false,disabled:false,textContent:'',classList:{toggle(){}},append(){},focus(){},select(){},showModal(){}});
...
const reviewNote=node();
const context=vm.createContext({els,URL,Blob,console,draft:{sourceFingerprint:'test',channels:[{included:true,needsCategoryReview:true},{included:false,needsCategoryReview:true}]},saving:false,pendingChannelSaves:0,publishing:false,publishedExport:null,internalExportBase:'',exportSettingsRequest:0,
 ...
 document:{getElementById(){return reviewNote},execCommand(){return true},createElement(){return {click(){},remove(){}}},body:{append(){}}},
...
(async()=>{
 ...
 assert.ok(reviewNote.textContent.startsWith('1 included channels'));
