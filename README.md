...
| Spectrum | Official national channel catalog | Ships 378 reviewed channel names/categories from the public page and joins only by exact Spectrum TMSID/Gracenote station ID. The catalog supplies no local availability or channel-number evidence. Live checks are limited to once per seven days; failures retain the last-known-good or bundled snapshot. |
